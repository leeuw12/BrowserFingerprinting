let submit_message = function () {
    ...
    parametrs.deviceMemory = checkMe(navigator.deviceMemory)
    parametrs.languagesSet = languagesSet()
    parametrs.timezone = getTimezoneOffset()
    parametrs.connectedDevices = getConnectedDevices()
    parametrs.cookie = checkMe(navigator.cookieEnabled)
    parametrs.donottrack = checkMe(Navigator.doNotTrack)
